...
LABEL_MAP = json.load(open(os.path.join(base, 'label_map.json'), encoding='utf-8'))
...
TMPL = open(os.path.join(base, '_viewer_tmpl.html'), encoding='utf-8').read()
HTML = TMPL.replace('/*DATA_PLACEHOLDER*/', DATA_JSON)

out = os.path.join(base, 'prompt-viewer-v2.html')
